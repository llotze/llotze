...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    root = tree.getroot()
    find_and_replace(root, 'age_data', age_data)  # Add this line!
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 2, 29))
    print("DEBUG - Age data:", age_data)  # Add this line
